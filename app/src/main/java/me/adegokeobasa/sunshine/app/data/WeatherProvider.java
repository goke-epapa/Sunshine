package me.adegokeobasa.sunshine.app.data;//
/*
...
public class WeatherProvider extends ContentProvider {
    ...
    public static final String sLocationIdSelection = WeatherContract.LocationEntry.TABLE_NAME +
            "." + WeatherContract.LocationEntry._ID + " = ? ";

    private Cursor getLocationByLocationId(Uri uri, String[] projection, String sortOrder) {
        long locationId = ContentUris.parseId(uri);
        String[] selectionArgs;
        String selection;

        selectionArgs = new String[]{String.valueOf(locationId)};
        selection = sLocationIdSelection;
     ...
     public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
         ...
         switch (sUriMatcher.match(uri)) {
              ...
              **/
             case LOCATION_ID: {
                 retCursor = getLocationByLocationId(uri, projection, sortOrder);
                 break;
             }
