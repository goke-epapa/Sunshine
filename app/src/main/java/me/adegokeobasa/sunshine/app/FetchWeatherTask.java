...
//
//    public FetchWeatherTask(FragmentActivity activity, ArrayAdapter<String> adapter) {
...
//
//            weatherForecasts = getWeatherDataFromJson(forecastJsonStr, numDays, locationQuery);
//        } catch (IOException e) {
//            Log.e(TAG, "Error ", e);
...
//            String tempUnits = preferences.getString(this.activity.getString(R.string.pref_temperature_units_key),
//                    this.activity.getString(R.string.pref_temperature_units_default));
//
...
//        String locationQuery = WeatherContract.LocationEntry.TABLE_NAME +
...
//            Uri locationUri = activity.getContentResolver().insert(WeatherContract.LocationEntry.CONTENT_URI, contentValues);
...
public class FetchWeatherTask extends AsyncTask<String, Void, Void> {
    ...
    private String formatHighLows(double high, double low) {
        ...
        String unitType = sharedPrefs.getString(
                mContext.getString(R.string.pref_temperature_units),
    ...
    private String[] getWeatherDataFromJson(String forecastJsonStr, int numDays,
        ...
        if(cVVector.size() > 0) {
            ContentValues[] bulkWeatherValues = new ContentValues[cVVector.size()];
            mContext.getContentResolver()
                    .bulkInsert(WeatherEntry.CONTENT_URI, cVVector.toArray(bulkWeatherValues));
        }
